...
**Document History**:
- v5.9 (2026-04-14): Maintenance tone scan — fixed 1 tone issue: `github-actions-security-best-practices.md` (line 166: "more robust than `ls`" → "handles filenames with spaces and special characters correctly, unlike `ls` output which requires additional parsing"). Coverage: 64 spec files (no new files).
